package applerodite.meditaion

import applerodite.config.CommonService
import applerodite.mediation.{Param, ResultRow, Template}
...
object Main extends Template {
  ...
  override def exec(svc: CommonService, param: Param): Seq[Row] = {
    ...
    val res = BCGraph.vertices.map(v=>ResultRow.apply(`score` = v._2._1, `id` = v._1, `artifact` = v._2._2.get.Artifact, `version` = v._2._2.get.Version)).collect()
