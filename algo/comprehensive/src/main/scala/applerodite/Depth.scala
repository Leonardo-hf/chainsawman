...
object Depth extends Impact {
  def main(args: Array[String]): Dataset[Row] = {
    ...
    spark.sqlContext.createDataFrame(res.vertices.map(v => Row.apply(v._1, v._2._2.get.Artifact, v._2._2.get.Version, v._2._1)), SCHEMA_DEFAULT).orderBy(desc(AlgoConstants.SCORE_COL))
  }
}
