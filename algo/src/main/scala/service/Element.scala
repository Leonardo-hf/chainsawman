...
final case class Element(
                          ...
                          `type`: service.Element.Type = service.Element.Type.INT64,
    ...
    def withType(__v: service.Element.Type): Element = copy(`type` = __v)
    ...
    def companion: service.Element.type = service.Element
    // @@protoc_insertion_point(GeneratedMessage[services.Element])
}

object Element extends scalapb.GeneratedMessageCompanion[service.Element] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[service.Element] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): service.Element = {
    var __key: _root_.scala.Predef.String = ""
    var __type: service.Element.Type = service.Element.Type.INT64
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 16 =>
          __type = service.Element.Type.fromValue(_input__.readEnum())
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[service.Element] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      service.Element(
        key = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        `type` = service.Element.Type.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(service.Element.Type.INT64.scalaValueDescriptor).number)
      )
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 2 => service.Element.Type
    }
  }
  lazy val defaultInstance = service.Element(
    key = "",
    `type` = service.Element.Type.INT64
  )
  sealed abstract class Type(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[Type] = service.Element.Type
    final def asRecognized: _root_.scala.Option[service.Element.Type.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[service.Element.Type.Recognized])
  }
  ...
  object Type extends _root_.scalapb.GeneratedEnumCompanion[Type] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = service.Element.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = service.Element.scalaDescriptor.enums(0)
  }
  implicit class ElementLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, service.Element]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, service.Element](_l) {
    def key: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.key)((c_, f_) => c_.copy(key = f_))
    def `type`: _root_.scalapb.lenses.Lens[UpperPB, service.Element.Type] = field(_.`type`)((c_, f_) => c_.copy(`type` = f_))
  }
  ...
  ): _root_.service.Element = _root_.service.Element(
    key,
    `type`
  )
