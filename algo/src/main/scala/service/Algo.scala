...
final case class Algo(
    ...
    def withType(__v: service.Algo.Type): Algo = copy(`type` = __v)
    ...
    def companion: service.Algo.type = service.Algo
    // @@protoc_insertion_point(GeneratedMessage[services.Algo])
}

object Algo extends scalapb.GeneratedMessageCompanion[service.Algo] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[service.Algo] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): service.Algo = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[service.Algo] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      service.Algo(
        ...
        `type` = service.Algo.Type.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(service.Algo.Type.Rank.scalaValueDescriptor).number)
      )
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 5 => service.Algo.Type
    }
  }
  lazy val defaultInstance = service.Algo(
    id = 0L,
    name = "",
    desc = "",
    isCustom = false,
  ...
  sealed abstract class Type(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[Type] = service.Algo.Type
    final def asRecognized: _root_.scala.Option[service.Algo.Type.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[service.Algo.Type.Recognized])
  }
  ...
  object Type extends _root_.scalapb.GeneratedEnumCompanion[Type] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = service.Algo.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = service.Algo.scalaDescriptor.enums(0)
  }
  implicit class AlgoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, service.Algo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, service.Algo](_l) {
  ...
  ): _root_.service.Algo = _root_.service.Algo(
    id,
    name,
    desc,
    isCustom,
