...
final case class Cluster(
    ...
    def companion: services.Cluster.type = services.Cluster
    // @@protoc_insertion_point(GeneratedMessage[services.Cluster])
}

object Cluster extends scalapb.GeneratedMessageCompanion[services.Cluster] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[services.Cluster] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): services.Cluster = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[services.Cluster] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = services.Cluster(
    name = "",
    nodes = _root_.scala.Seq.empty
  )
  implicit class ClusterLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, services.Cluster]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, services.Cluster](_l) {
  ...
  ): _root_.services.Cluster = _root_.services.Cluster(
    name,
    nodes
  )
