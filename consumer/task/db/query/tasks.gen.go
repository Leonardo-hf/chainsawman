...
func newTask(db *gorm.DB, opts ...gen.DOOption) task {
	...
	_task.Idf = field.NewString(tableName, "idf")
	_task.CreateTime = field.NewTime(tableName, "createTime")
	_task.UpdateTime = field.NewTime(tableName, "updateTime")
...
func (t *task) updateTableName(table string) *task {
	...
	t.Idf = field.NewString(table, "idf")
