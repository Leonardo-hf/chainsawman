...
type AlgoEcology struct {
}

func (h *AlgoEcology) Handle(task *model.KVTask) (string, error) {
	...
	res, err := config.AlgoRPC.Ecology(ctx, &algo.BaseReq{GraphID: req.GraphID, EdgeTags: edgeTags})
	if err != nil {
		return "", err
	}
