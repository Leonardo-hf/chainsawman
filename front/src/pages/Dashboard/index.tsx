    ...
    return <PageContainer>
        <div style={{display: 'flex', flexDirection: 'column'}}>
            <Row gutter={16}>
                <Col span={8}>
                    <ProCard>
                        <Statistic title="图谱数目" value={4} formatter={formatter}/>
                    </ProCard>
                </Col>
                <Col span={8}>
                    <ProCard>
                        <Statistic title="累计节点数目" value={4234} precision={2} formatter={formatter}/>
                    </ProCard>
                </Col>
                <Col span={8}>
                    <ProCard>
                        <Statistic title="累计边数目" value={22321} precision={2} formatter={formatter}/>
                    </ProCard>
                </Col>
            </Row>
            <Divider/>
