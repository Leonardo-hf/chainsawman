...
type Graph struct {
	...
	CreateTime time.Time `gorm:"column:createTime;type:timestamp;default:CURRENT_TIMESTAMP;autoCreateTime" json:"createTime"`
	UpdateTime time.Time `gorm:"column:updateTime;type:timestamp;default:CURRENT_TIMESTAMP;autoUpdateTime" json:"updateTime"`
}
