...
func newAlgo(db *gorm.DB, opts ...gen.DOOption) algo {
	...
	_algo.Params = algoHasManyParams{
		...
		RelationField: field.NewRelation("Params", "model.AlgosParam"),
	}
...
func (a algoHasManyParamsTx) Find() (result []*model.AlgosParam, err error) {
	return result, a.tx.Find(&result)
}

func (a algoHasManyParamsTx) Append(values ...*model.AlgosParam) (err error) {
...
func (a algoHasManyParamsTx) Replace(values ...*model.AlgosParam) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a algoHasManyParamsTx) Delete(values ...*model.AlgosParam) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
