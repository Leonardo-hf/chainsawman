...
func newAlgoParam(db *gorm.DB, opts ...gen.DOOption) algoParam {
	...
	_algoParam.Name = field.NewString(tableName, "name")
	_algoParam.Desc = field.NewString(tableName, "desc")
	_algoParam.Type = field.NewInt64(tableName, "type")
	_algoParam.Default = field.NewString(tableName, "default")
	_algoParam.Max = field.NewString(tableName, "max")
	_algoParam.Min = field.NewString(tableName, "min")
...
func (a *algoParam) updateTableName(table string) *algoParam {
	...
	a.Max = field.NewString(table, "max")
	a.Min = field.NewString(table, "min")
