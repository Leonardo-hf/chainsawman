...
INSERT INTO graph.node(id, groupID, name, `desc`, `primary`) VALUES (4, 4, 'organization', '开发团队', 'artifact');
...
INSERT INTO graph.node(id, groupID, name, `desc`, `primary`) VALUES (5, 4, 'developer', '开发者', 'idf');
...
INSERT INTO graph.algo(id, name, `desc`, detail, groupId, tag, jarPath, mainClass) VALUES (9, 'diversity', '团队多元性，软件的开发团队中贡献者和维护者的国别越多样，该软件的团队多元性越高。', '团队多元性，软件的开发团队中贡献者和维护者的国别越多样，该软件的团队多元性越高。', 4, '软件风险', 's3a://lib/diversity-latest.jar', 'applerodite.diversity.Main');

INSERT INTO graph.algoParam(algoID, name, `desc`, type, `default`, `min`, `max`) VALUES (9, 'libraries', '待识别卡脖子风险的软件列表', 3, null, '1', null);
