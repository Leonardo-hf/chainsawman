...
INSERT INTO graph.nodeAttr(nodeID, name, `desc`, type) VALUES (5, 'home', '主页', 0);
...
INSERT INTO graph.algo(id, name, detail, groupId, tag, jarPath, mainClass) VALUES (10, 'diversity', '团队多元性，软件的开发团队中贡献者和维护者的国别越多样，该软件的团队多元性越高。', 3, '软件风险', 's3a://lib/diversity-latest.jar', 'applerodite.diversity.Main');

INSERT INTO graph.algoParam(algoID, name, `desc`, type, `default`, `min`, `max`) VALUES (10, 'libraries', '待识别卡脖子风险的软件列表', 3, null, '1', null);
